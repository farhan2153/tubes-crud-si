...
@section('content')
    <div class="d-flex justify-content-center flex-column align-items-center">
        ...
        <form action="/tiketkeretaapi/update/{{$tiketkeretaapi->id}}" method="POST" class="w-25 mt-3">
            @csrf
            @method('PUT')
            <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="id_kereta" id="id_kereta">
                    <option disabled value>Pilih Nama Kereta</option>
  ...
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga" value="{{$tiketkeretaapi->harga}}">
            </div>
            <div class="form-group">
                <label for="kelas" class="form-label">Kelas</label>
                <input type="text" class="form-control" id="kelas" name="kelas" placeholder="Masukkan Nama Pegawai" value="{{$tiketkeretaapi->kelas}}">
            </div>
